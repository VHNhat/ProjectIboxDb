...
namespace ProjectIboxDb.Sockets
{
    ...
    class Server
    {
        ...
        public static string path = "E:/Code Life/UIT/CSDLPT/ProjectIboxDb/bin/Debug/netcoreapp3.1/ibox";
        ...
        {
            /*string path = @$"E:\Code Life\UIT\CSDLPT\ProjectIboxDb\bin\Debug\netcoreapp3.1\ibox\db{addressDb}.box";
            string result = Path.GetFileName(path);*/

            string receiveFilePath = @$"E:\Code Life\UIT\CSDLPT\ProjectIboxDb\bin\Debug\netcoreapp3.1\ibox\{fName}";
            if (File.Exists(receiveFilePath))
            {
                File.Delete(receiveFilePath);
                File.Delete(receiveFilePath+".swp");
                WriteLine($"Delete existed file");
            }
